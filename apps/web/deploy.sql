...
-- ─────────────────────────────────────────────
-- Translated external wellness briefings — migrations 0008, 0010, 0012
-- ─────────────────────────────────────────────
DO $$ BEGIN
  CREATE TYPE "public"."external_content_status" AS ENUM(
    'rights_pending',
    'pending_translation',
    'published',
    'failed',
...
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;
ALTER TYPE "public"."external_content_status" ADD VALUE IF NOT EXISTS 'withdrawn';
...
CREATE TABLE IF NOT EXISTS "external_content_items" (
	...
	"status" "public"."external_content_status" DEFAULT 'rights_pending' NOT NULL,
