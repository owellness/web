...
const aboutBodyJson: TiptapDocument = {
  ...
  content: [
    ...
    heading("콘텐츠 원칙"),
    paragraph(
      "오! 웰니스가 직접 제작하는 모든 통계와 주장에는 출처를 함께 표기합니다. 직접 제작한 의료 관련 콘텐츠는 의료 검토자가 검토한 뒤 공개됩니다. 해외 웰니스 브리핑은 별도 의료 검수를 거치지 않은 기계 번역으로 명확히 구분하며, 모든 콘텐츠는 정보 제공을 목적으로 할 뿐 전문가의 진단·치료를 대체하지 않습니다.",
    ),
    heading("앞으로의 계획"),
    paragraph(
